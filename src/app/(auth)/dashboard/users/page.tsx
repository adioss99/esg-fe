      ...
      switch (role) {
        case "ADMIN":
          return (
            <Badge
              variant={"outline"}
              className="rounded-full outline-1 text-blue-400 outline-blue-400">
              {role.toLowerCase()}
            </Badge>
          );
        case "OPERATOR":
          return (
            <Badge
              variant={"outline"}
              className="rounded-full outline-1 text-yellow-400 outline-yellow-400">
              {role.toLowerCase()}
            </Badge>
          );
        case "QC":
          return (
            <Badge
              variant={"outline"}
              className="rounded-full outline-1 text-red-400 outline-red-400">
              {role.toLowerCase()}
            </Badge>
          );
      }
